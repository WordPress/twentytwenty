    ...
    ob_start();
		...
		*/
		...
		if ( 'front-end' === $type ) {
			...
			// Helper Classes.
			if ( $accent && $accent !== $accent_default ) :
				twentytwenty_generate_css( '.color-accent, .color-accent:hover, .has-accent-color', 'color', $accent );
				twentytwenty_generate_css( '.bg-accent, .bg-accent:hover, .has-accent-background-color', 'background-color', $accent );
				twentytwenty_generate_css( '.border-color-accent, .border-color-accent:hover', 'border-color', $accent );
